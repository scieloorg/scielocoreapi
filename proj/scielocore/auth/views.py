...
from scielocore.models import User
from scielocore.extensions import pwd_context, jwt, apispec
from scielocore.auth.helpers import revoke_token, is_token_revoked, add_token_to_database
